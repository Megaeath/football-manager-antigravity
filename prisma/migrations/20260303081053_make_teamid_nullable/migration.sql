...
CREATE TABLE "TransferHistory" (
    ...
    CONSTRAINT "TransferHistory_playerId_fkey" FOREIGN KEY ("playerId") REFERENCES "Player" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "TransferHistory_fromTeamId_fkey" FOREIGN KEY ("fromTeamId") REFERENCES "Team" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "TransferHistory_toTeamId_fkey" FOREIGN KEY ("toTeamId") REFERENCES "Team" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
INSERT INTO "new_Bid" ("amount", "createdAt", "fromTeamId", "id", "isFreeAgent", "playerId", "signOnBonus", "status", "toTeamId", "windowEnds") SELECT "amount", "createdAt", "fromTeamId", "id", "isFreeAgent", "playerId", "signOnBonus", "status", "toTeamId", "windowEnds" FROM "Bid";
DROP TABLE "Bid";
...
CREATE TABLE "new_Player" (
    ...
    "lastTransferredSeason" INTEGER NOT NULL DEFAULT 0,
    CONSTRAINT "Player_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "Team" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Player" ("acceleration", "age", "aggression", "agility", "apps", "askingPrice", "assists", "avgRating", "balance", "birthDate", "bravery", "composure", "condition", "contractEndWeek", "contractStartWeek", "corners", "crossesAttempted", "crossesCompleted", "crossing", "dribbling", "exp", "freeKicks", "goals", "handling", "heading", "id", "isRetired", "lastTransferredSeason", "leadership", "morale", "motmCount", "name", "naturalPosition", "pace", "passesAttempted", "passesCompleted", "passing", "popularity", "positioning", "redCards", "retirementAge", "setPieces", "shooting", "squadStatus", "stamina", "strength", "tackling", "tacticalPosition", "teamId", "teamwork", "throw", "throws", "transferStatus", "vision", "weeklyWage", "yellowCards") SELECT "acceleration", "age", "aggression", "agility", "apps", "askingPrice", "assists", "avgRating", "balance", "birthDate", "bravery", "composure", "condition", "contractEndWeek", "contractStartWeek", "corners", "crossesAttempted", "crossesCompleted", "crossing", "dribbling", "exp", "freeKicks", "goals", "handling", "heading", "id", "isRetired", "lastTransferredSeason", "leadership", "morale", "motmCount", "name", "naturalPosition", "pace", "passesAttempted", "passesCompleted", "passing", "popularity", "positioning", "redCards", "retirementAge", "setPieces", "shooting", "squadStatus", "stamina", "strength", "tackling", "tacticalPosition", "teamId", "teamwork", "throw", "throws", "transferStatus", "vision", "weeklyWage", "yellowCards" FROM "Player";
DROP TABLE "Player";
