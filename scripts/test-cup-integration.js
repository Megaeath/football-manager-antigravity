...
async function main() {
  ...
  // Reset current cup data for clean integration run
  ...
  // Seed random knockout from top 16
  ...
  // Knockout simulation rounds 1..4
